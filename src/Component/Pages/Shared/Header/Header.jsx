...
const Header = () => {
  ...
  <div className="navbar-start">
    ...
    <a className="italic font-bold text-2xl"><span className="text-blue-700">M</span><span className="text-red-600">y</span> <span className="text-orange-700">P</span><span className="text-blue-700">or</span><span className="text-orange-700">t</span><span className="text-red-600">fo</span><span className="text-blue-700">li</span><span className="text-orange-700">o</span></a>
  </div>
